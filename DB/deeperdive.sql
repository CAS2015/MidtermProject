...
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `create_date`, `img_url`) VALUES (4, 'user3', 'user3', 1, 'data_writer', 'John', 'Lennon', '2021-03-17 04:00:00', 'https://images.freeimages.com/images/large-previews/0c6/surfs-up-3-1539300.jpg');
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `create_date`, `img_url`) VALUES (5, 'user2', 'user2', 1, 'data_writer', 'Paul', 'McCartney', '2021-03-18 04:00:00', 'https://images.freeimages.com/images/large-previews/0c6/surfs-up-3-1539300.jpg');
...
START TRANSACTION;
USE `deeperdivedb`;
INSERT INTO `location` (`id`, `location_name`, `region`, `country`, `water_type`, `minimum_temperature_celsius`, `maximum_temperature_celsius`, `description`, `img_url`) VALUES (1, 'NotReal Location Name', 'Sao Paolo', 'Brazil', 'fresh water', 10, 25, 'This place is great and has this awesome people', 'https://images.freeimages.com/images/large-previews/9fc/lovin-scuba-1402120.jpg');
INSERT INTO `location` (`id`, `location_name`, `region`, `country`, `water_type`, `minimum_temperature_celsius`, `maximum_temperature_celsius`, `description`, `img_url`) VALUES (2, 'Dutch Springs', 'Pennsylvania', 'United States', 'fresh water', 14, 22, 'It’s in Pennsylvania with an easy access and great people', 'https://images.freeimages.com/images/large-previews/9fc/lovin-scuba-1402120.jpg');
INSERT INTO `location` (`id`, `location_name`, `region`, `country`, `water_type`, `minimum_temperature_celsius`, `maximum_temperature_celsius`, `description`, `img_url`) VALUES (3, 'Kota Kinabalu', 'Sabah', 'Malaysia', 'salt water', 30, 30, 'A bit sketchy to get to this location, but the scene is amazing', 'https://images.freeimages.com/images/large-previews/9fc/lovin-scuba-1402120.jpg');
INSERT INTO `location` (`id`, `location_name`, `region`, `country`, `water_type`, `minimum_temperature_celsius`, `maximum_temperature_celsius`, `description`, `img_url`) VALUES (4, 'Bunaken', 'North Sulawesi', 'Indonesia', 'salt water', 29, 29, 'Beautiful, and a the water is really calm on most days', 'https://images.freeimages.com/images/large-previews/9fc/lovin-scuba-1402120.jpg');
INSERT INTO `location` (`id`, `location_name`, `region`, `country`, `water_type`, `minimum_temperature_celsius`, `maximum_temperature_celsius`, `description`, `img_url`) VALUES (5, 'Lembeh', 'North Sulawesi', 'Indonesia', 'salt water', 27, 28, 'Mix of both worlds with gracious scenery but its can be very hard to get access', 'https://images.freeimages.com/images/large-previews/9fc/lovin-scuba-1402120.jpg');
INSERT INTO `location` (`id`, `location_name`, `region`, `country`, `water_type`, `minimum_temperature_celsius`, `maximum_temperature_celsius`, `description`, `img_url`) VALUES (6, 'Komodo', 'East Nusa Tenggara', 'Indonesia', 'salt water', 27, 28, 'Exotic but really approachable and the atmosphere is phenomenal', 'https://images.freeimages.com/images/large-previews/9fc/lovin-scuba-1402120.jpg');
